function [Cg1,Cm1]=inversionGrGrtd_mmm_fq1(Vg,Vt,g,T,Imax,Wdg0,Wdt0,Wzg0,Wzt0,Dx,Dy,Dz,indqy0)
num=0;
k=0;
[aa,bb]=size(Vg);
[~,bbt]=size(Vt);
...
while num<=Imax
    ...
    %%
    if (k>90)
        agg=0.6; atg=0.09; attg=0.09;
        agg=0.; atg=0.0; attg=0.0;
        a1=0.5; a2=0.22; a3=0.22;
        ax=1;ay=1;az=1;
        aggx=a1; aggy=a1; aggz=a1;
        atgx=ax*a2; atgy=ay*a2; atgz=az*a2;
        attgx=ax*a3;attgy=ay*a3;attgz=az*a3;
    else
        agg=0.5; atg=0.25; attg=0.25;
        agg=0.; atg=0.0; attg=0.0;
        a1=0.7; a2=0.43; a3=0.43;
        ax=10;ay=10;az=1;
        aggx=a1; aggy=a1; aggz=a1;
        atgx=ax*a2; atgy=ay*a2; atgz=az*a2;
        attgx=ax*a3;attgy=ay*a3;attgz=az*a3;
