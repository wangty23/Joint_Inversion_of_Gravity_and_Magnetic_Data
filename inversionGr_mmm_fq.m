function [Cg1,Cm1]=inversionGr_mmm_fq(Gg,Gt,g,T,Imax,Wdg0,Wdt0,Wzg0,Wzt0,indqy)
num=0;
k=0;
[aa,bb]=size(Gg);
[~,bbt]=size(Gt);
...
q111gG=zeros(bb,nqy);
q111tG=zeros(bbt,nqy);
q111ttG=zeros(bbt,nqy);
...
while num<=Imax
    ...
    q11g=p1g;   q11t=p1t;
    v2g=(r1g'*p1g)/(q1g'*q1g+ag*(q11g'*q11g)+abs(agg1)*qgv);
    v2t=(r1t'*p1t)/(q1t'*q1t+at*(q11t'*q11t)+abs(atg1)*qtv+abs(attg1)*qttv);
    Cg1=Cg1+v2g*p1g;
    Cm1=Cm1+v2t*p1t;
    Cg1=Wzg1*Cg1;
    Cm1=Wzt1*Cm1;
