function [Cg1,Cm1]=inversionGrtd_mmm_fq(Gg,Gt,g,T,Imax,Wdg0,Wdt0,Wzg0,Wzt0,Dx,Dy,Dz,indqy)
num=0;
k=0;
[aa,bb]=size(Gg);
[~,bbt]=size(Gt);
...
while num<=Imax
    ...
    r1g=r1g0-aggx1*sum(q1gGdx,2)-aggy1*sum(q1gGdy,2)-aggz1*sum(q1gGdz,2);
    r1t=r1t0-atgx1*sum(q1tGdx,2)-atgy1*sum(q1tGdy,2)-atgz1*sum(q1tGdz,2)...
