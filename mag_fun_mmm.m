function [T,dt_mx,dt_my,dt_mz]=mag_fun_mmm(Vcc,xyz0,xyz,size0,IId,DDd,II0d,DD0d)
G=6.67*10^-2;
II = pi * IId / 180.;
DD = pi * DDd / 180.;
II0 = pi * II0d / 180.;
...
dt_mx=(vxx* alphaT+vxy*betaT+vxz*gammaT)* 100 / G;
dt_my=(vxy* alphaT+vyy*betaT+vyz*gammaT)* 100 / G;
dt_mz=(vxz* alphaT+vyz*betaT+vzz*gammaT)* 100 / G;
